...
#ifndef FFMPEGPROJECT_MEDIA_ARGUMENTS_H
#define FFMPEGPROJECT_MEDIA_ARGUMENTS_H

#include "jni.h"

class LXJNIHandler;
typedef struct LXMediaArguments {
    ...
    LXJNIHandler *handler; // 一个全局处理对象的指针
};


#endif //FFMPEGPROJECT_MEDIA_ARGUMENTS_H
