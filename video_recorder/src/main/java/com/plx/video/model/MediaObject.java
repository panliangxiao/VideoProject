...
public class MediaObject implements Serializable {
    ...
    public String getConcatYUV() {
        ...
        if (mMediaList != null && mMediaList.size() > 0) {
            if (mMediaList.size() == 1) {
                if (TextUtils.isEmpty(mMediaList.get(0).tempMediaPath))
                ...
                for (int i = 0, j = mMediaList.size(); i < j; i++) {
                    ...
                    if (TextUtils.isEmpty(part.tempMediaPath))
    ...
    public String getConcatPCM() {
        ...
        if (mMediaList != null && mMediaList.size() > 0) {
            if (mMediaList.size() == 1) {
                if (TextUtils.isEmpty(mMediaList.get(0).tempAudioPath))
                ...
                for (int i = 0, j = mMediaList.size(); i < j; i++) {
                    MediaPart part = mMediaList.get(i);
                    if (TextUtils.isEmpty(part.tempAudioPath))
