...
public class MediaRecorderConfig implements Parcelable {
        ...
        public static class Builder {
            ...
            /**
             * 小视频高度,TODO 注意：宽度不能随意传，需要传送手机摄像头手支持录制的视频高度，注意是高度（因为会选择，具体原因不多解析）。
             * 获取摄像头所支持的尺寸的方式是{@link android.graphics.Camera #getSupportedPreviewSizes()}
             * 一般支持的尺寸的高度有：240、480、720、1080等，具体值请用以上方法获取
             */
             ...
             * @return
             */
            public Builder maxRecordTime(int RECORD_TIME_MAX) {
             ...
             * @return
             */
            public Builder minRecordTime(int RECORD_TIME_MIN) {
             ...
             * @return
             */
            public Builder videoHeight(int SMALL_VIDEO_HEIGHT) {
             ...
             * @return
             */
            public Builder videoWidth(int SMALL_VIDEO_WIDTH) {
             ...
             * @return
             */
            public Builder bitrate(int VIDEO_BITRATE) {
