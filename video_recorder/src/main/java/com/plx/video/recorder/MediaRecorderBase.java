...
import com.plx.video.utils.DeviceUtils;
import com.plx.video.utils.FileUtils;
import com.plx.video.utils.StringUtils;
...
public abstract class MediaRecorderBase implements IMediaRecorder, Camera.PreviewCallback, SurfaceHolder.Callback {
...
//		TODO 设置浏览尺寸
    ...
    public void release() {
        ...
        FFmpegNativeBridge.nativeRelease();
        stopAllRecord();
        // 停止视频预览
        stopPreview();
        // 停止音频录制
